...
| [ADR-010](./010-workflow-connector-workspace-and-node-bridge-architecture.md) | Connector Boundary and Workspace Separation for Managed Connector Nodes | **Accepted ✅** | 2026-04-20 |
