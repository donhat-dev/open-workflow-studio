...
| **E4.6: Editor State Refactor** | P1       | 32           | 40%     | 🔄 In Progress |
...
| **E4.6** | **Editor State Architecture Refactor (Studio-like)**        | **32** | P0       |  **40%** | 🔄 In Progress | Sprint 3                                 |
| E4.6.1   | workflowEditor service (reactive state + actions + history) |      8 | P0       |     100% | ✅             | Canonical graph/ui state                 |
| E4.6.2   | Per-editor useSubEnv + scoped editorBus                     |      6 | P0       |       0% | ❌             | Multi-editor support                     |
| E4.6.3   | Refactor EditorCanvas to service-driven                     |      6 | P0       |      50% | 🔄             | Remove callback props                    |
| E4.6.4   | Refactor panels/menu/toolbar to service-driven              |      6 | P0       |      80% | 🔄             | Config, menu, node toolbar               |
| E4.6.5   | Extract Studio-like hooks + pure utils                      |      4 | P0       |       0% | ❌             | Behavior hooks, geometry/selection utils |
| E4.6.6   | Undo/redo batching + UI feedback                            |      2 | P0       |       0% | ❌             | Batch operations via service             |
