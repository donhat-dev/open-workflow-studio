...
class TestWorkflowExtensionApi(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self._nodes_by_callable_key_backup = (
            WorkflowNodeRegistry._nodes_by_callable_key.copy()
        )
    ...
    def tearDown(self):
        ...
        WorkflowNodeRegistry._nodes_by_callable_key = (
            self._nodes_by_callable_key_backup.copy()
        )
        super().tearDown()
    ...
    def test_workflow_node_decorator_syncs_and_executes_callable(self):
        ...
        runtime_type = self.WorkflowType.search(
            [("node_type", "=", node_type)], limit=1
        )
    ...
    def test_workflow_node_logs_warning_for_missing_doc(self):
        ...
        with self.assertLogs(
            "odoo.addons.workflow_studio.workflow", level="WARNING"
        ) as log_cm:
