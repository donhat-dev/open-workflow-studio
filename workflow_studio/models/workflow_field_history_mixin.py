...
from .workflow_diff_utils import compute_snapshot_hash, generate_workflow_comparison
...
class WorkflowFieldHistory(models.AbstractModel):
    ...
    def workflow_field_history_get_content_at_revision(self, field_name, revision_id):
        ...
        target_rev = next(
            (r for r in revisions if r["revision_id"] == revision_id), None
        )
